 ...
 * Connect to a running openMSX process to perform operations such as session management (mute, pause, etc), take screenshots, save and load states, type text, enter passwords (using a built-in database of known game passwords), enable cheats, switch disks or tapes and copy BASIC listings to clipboard.
 ...
 * Filter games by company, year, country, medium, size, MSX generation, sound chip, genre, user-defined game data and recently added or updated games, and save these filters for later use.
 ...
 * Launch ColecoVision ROM games on Gearcoleco.
